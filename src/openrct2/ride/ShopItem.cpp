...
constexpr ShopItemDescriptor ShopItems[EnumValue(ShopItem::Count)] = {
    ...
    /* ShopItem::CreditCard */       {  0.00_GBP, 0.00_GBP,   0.00_GBP,  0.00_GBP,   0.00_GBP,      SPR_SHOP_ITEM_VOUCHER,             { STR_SHOP_ITEM_PRICE_LABEL_VOUCHER,                STR_SHOP_ITEM_SINGULAR_CREDITCARD,          STR_SHOP_ITEM_SINGULAR_CREDITCARD,          STR_SHOP_ITEM_INDEFINITE_VOUCHER,               STR_SHOP_ITEM_SINGULAR_CREDITCARD         }, 0,                                                           Litter::Type::Rubbish,          0,                ShopItem::None,             PeepThoughtType::None,                  PeepThoughtType::None               },
};
// clang-format on
