...
static void GuestTriedToEnterFullQueue(Guest& guest, Ride& ride)
{
    ...
    if (ride.id == guest.GuestHeadingToRideId || guest.getNextProxyRide() == &ride)
    {
        GuestResetRideHeading(guest);
    }
}
...
{
    // ... initialize RideIntensitySatisfaction and other members using coords
    RideIntensitySatisfaction = {};
}
*/
